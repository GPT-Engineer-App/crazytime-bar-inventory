...
const MobileSidebar = () => {
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="left" className={`flex flex-col shadow-lg ${isExpanded ? 'w-64' : 'w-16'}`}>
        <Button variant="ghost" size="icon" className="self-end" onClick={() => setIsExpanded(!isExpanded)}>
